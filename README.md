# BEM PUG SCSS starter

## Особенности
* используется БЭМ-структура (https://ru.bem.info/)
...
* перейдите в скачанную папку со сборкой: ```cd project-name```
...
* все компоненты импортируются в файл ```src/views/helpers/mixin.pug``` после чего становяться доступны глобально на всех страницах
...
* Сборка модифицирована и доработана на основе сборки от https://github.com/andreyalexeich/gulp-pug-starter